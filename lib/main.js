...
function createComment(octokit) {
    return __awaiter(this, void 0, void 0, function* () {
        yield octokit.issues.createComment(Object.assign(Object.assign({}, toolkit.context.repo), { issue_number: toolkit.context.issue.number, body: `@${toolkit.context.actor} your pull request is missing a changelog!` }));
    });
}
function token() {
